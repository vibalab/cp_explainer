...
/**
 * This function draws a rounded rectangle on the input canvas 2D context.
...
export function drawHover(
  ...
  context.font = `bold ${subLabelSize}px ${font}`; // Bold added to coreLabel
  const clusterLabelWidth = coreLabel
    ? context.measureText(coreLabel).width
    : 0;
  ...
  context.fillStyle = data.core_periphery === 0 ? "#495057" : "#87CEEB";
  context.font = `bold ${subLabelSize}px ${font}`; // Bold added to coreLabel
  context.fillText(
    coreLabel,
    data.x + data.size + 3,
